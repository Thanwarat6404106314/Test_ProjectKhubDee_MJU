    ...
    <main class="listviolation sarabun-regular mt-5">
        <div class="container d-flex justify-content-between align-items-end mb-4">
            <section>
                ...
                <p class="h5 text-muted">สถานะ: ไม่อนุมัติหักคะแนนพฤติกรรม</p>
            </section>
        </div>
        
        <div class="container d-flex justify-content-center align-items-center">
		   	<form class="d-flex" action="search-rejected" method="GET">
        ...
        <div class="album py-2 mt-3 ">
		    ...
		    <div class="container mt-3">
		        <table class="table table-striped" id="myTable">
		            ...
		            <tbody>
					    <c:forEach items="${ListRVRejected}" var="RV" varStatus="NO">
					        <tr>
					            <form action="update-statustype" method="POST" onsubmit="return confirmChangeStatus(this)">
					                ...
					                <td>
					                    <a class="btn btn-sm btn-primary me-2" href="view-violation-rejected?record_id=${RV.record_id}">
		        ...
		        <c:if test="${empty ListRVRejected}">
