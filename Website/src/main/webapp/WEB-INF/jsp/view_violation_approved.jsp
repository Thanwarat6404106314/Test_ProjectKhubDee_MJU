...
<body>
    ...
    <main class="news news-view sarabun-regular mt-5">
        <div class="container d-flex justify-content-start align-items-start gap-4 mb-4">
            <a class="btn-back btn btn-primary d-flex align-items-center gap-2" href="list-violation-approved">
                    ...
                    <div class="container d-flex flex-column align-item-start">
                        ...
                        <div class="row mb-3 ">
						    ...
						    <div class="col-md-6 d-flex align-items-center">
	                            ...
	                            <input type="text" class="form-control" id="name" placeholder="${RVA.student.firstname} ${RVA.student.lastname}" readonly disabled>
	                        </div>
						</div>
                        ...
                        <div class="row mb-3">
						    <div class="col-md-6 d-flex align-items-center">
						        ...
						        <input type="text" class="form-control" id="major" placeholder="${RVA.student.major}" readonly disabled>
						    </div>
						    <div class="col-md-6 d-flex align-items-center">
						        <label for="faculty" class="me-3 mb-0 text-nowrap">สาขา :</label>
						        <input type="text" class="form-control" id="faculty" placeholder="${RVA.student.faculty}" readonly disabled>
						    </div>
						</div>
						<div class="row mb-3">
						    <div class="col-md-6 d-flex align-items-center">
						        <label for="major" class="me-3 mb-0 text-nowrap">คะแนนพฤติกรรม คงเหลือ :</label>
						        <input type="text" class="form-control" id="student_score" placeholder="${RVA.student.student_score} คะแนน" readonly disabled>
						    </div>
						</div>
		        		...
		        		<div class="row mb-3">
			        		<div class="col-md-6 d-flex align-items-center" >
							    ...
							    <input type="text" class="form-control" id="officer_id" placeholder="${RVA.officer.firstname} ${RVA.officer.lastname}" readonly disabled>
							</div>
						</div>
		        		<div class="row mb-3">
						    <div class="col-md-6 d-flex align-items-center">
						        <label for="record_date" class="me-3 mb-0 text-nowrap">วันที่ละเมิดกฎจราจร :</label>
						    	<input type="text" class="form-control" placeholder="<fmt:formatDate value='${RVA.record_date}' pattern='dd/MM/yyyy' />" readonly disabled>
						    </div>
						    <div class="col-md-6 d-flex align-items-center">
						        <label for="record_date" class="me-3 mb-0 text-nowrap">เวลา :</label>
						    	<input type="text" class="form-control" placeholder="<fmt:formatDate value='${RVA.record_date}' pattern='HH:mm น.' />" readonly disabled>
	                        </div>
						</div>
						<div class="row mb-3">
							<div class="col-md-6 d-flex align-items-center">
								<label for="location" class="me-3 mb-0 text-nowrap">สถานที่ :</label>
							    <input type="text" class="form-control" id="location" placeholder="${RVA.location.location_name}" readonly disabled>
							</div>
							<div class="col-md-6 d-flex align-items-center">
								<label for="status_type" class="me-3 mb-0 text-nowrap">ประเภทความผิด :</label>
								<input type="text" class="form-control" id="violation_type" placeholder="${RVA.violationType.violation_name}" readonly disabled>
							</div>
						</div>	
						<div class="row mb-3">
							<div class="col-md-6 d-flex align-items-center">
								<label for="status_type" class="me-3 mb-0 text-nowrap">สถานะ :</label>
								<input type="text" class="form-control" id="status_type" placeholder="${RVA.status_type}" readonly disabled>
							</div>
						</div>
						<div class="mb-3">
							<label for="status_type">รูปภาพการกะทำผิดกฎจราจร :</label>
							<div class="img-container mt-3">
                            	<img id="violation-image" src="picture_evidence/${RVA.picture_evidence}" alt="${RVA.record_id}">
                        	</div>
						</div>
