    ...
    <main class="listviolation sarabun-regular mt-5">
        <div class="container d-flex justify-content-between align-items-end mb-4">
            <section>
                ...
                <p class="h5 text-muted">สถานะ: กำลังพิจารณา</p>
            </section>
        </div>
        ...
        <div class="album py-2 mt-3 ">
       		<div class="container d-flex justify-content-end align-items-center">
				<!--
				<a class="btn btn-success " href="export-excel-violation">
    				<i class="fa-solid fa-plus me-2"></i>
    				<span>Export Excel</span>
				</a>
				-->
				<a class="btn btn-primary ms-2" href="export-pdf-violation">
    				<i class="fa-solid fa-plus me-2"></i>
		    ...
		    <div class="container mt-3">
		        <table class="table table-striped" id="myTable">
		            ...
		            <tbody>
					    <c:forEach items="${ListRecordViolation}" var="RV" varStatus="NO">
					        <tr>
					            <form action="update-statustype" method="POST" onsubmit="return confirmChangeStatus(this)">
					                ...
					                <td>
					                    <c:choose>
					                        <c:when test="${officer.position == 'หัวหน้าฝ่ายระเบียบวินัย'}">
					                            <select name="status-type" class="form-control data form-select">
					                ...
					                <td>
					                    <a class="btn btn-sm btn-primary me-2" href="view-violation?record_id=${RV.record_id}">
		        ...
		        <c:if test="${empty ListRecordViolation}">
